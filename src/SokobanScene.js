        ...
        for (var yy = 0; yy < this.mapData.height; yy++) {
            for (var xx = 0; xx < this.mapData.width; xx++) {
                if (this.isWall(xx, yy)) {
                    this.add.image(xx * TILESIZE + INDENT, yy * TILESIZE, 'wall')
                } else if (this.isTarget(xx, yy)) {
                    this.add.image(xx * TILESIZE + INDENT, yy * TILESIZE, 'target')
                } else if (this.isEmpty(xx, yy)) {
                    this.add.image(xx * TILESIZE + INDENT, yy * TILESIZE, 'empty')
                }
            }
        }
